...
if __name__ == "__main__":
    opt = parse_args(['--log_dir=../data/logs/sparse_sampled_test_ResUNet_Dropout_2Head_fixed_points_1',
                      '--log_iter=200',
                      '--batch_size=8',
                      '--checkpoint=../saves/sparse_sampled_train_ResUNet_Dropout_2Head_fixed_points_1/save_330499.pth',
                      '--num_heads=two',
